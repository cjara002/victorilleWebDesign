            ...
            <div className="row block-center mt-4 ">
                        ...
                        <form onSubmit={this.handleSubmit} name="contact" data-netlify="true">
                          ...
                          <p>
                            <label className="formMessage">
                              Message: <textarea name="message" defaultValue={""} value={message} onChange={this.handleChange} />
                            </label>
                          </p>
                          <p>
               ...
               <ul> 
                 <li>
                        ...
                        <img src={Github} className="img-responsive" alt="github">
                          </img>
                        </a>
                 </li>
                 <li>
                        <a href="www.linkedin.com/in/carlos-j-jara">
                        <img src={LinkedIn} className="img-responsive" alt="linkedin">
                          </img>
                          </a>
                 </li>
               </ul>
